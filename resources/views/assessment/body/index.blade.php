...
<head>
	...
	<title>PsyCheck | Body Assessment</title>
            ...
            <div class="relative overflow-hidden rounded-[32px] bg-[linear-gradient(180deg,#fff7fb_0%,#fff1f6_100%)] p-8 sm:p-10 shadow-[0_20px_55px_rgba(89,29,63,.05)] ring-1 ring-fuchsia-100/70">
                ...
                <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                    <div class="max-w-2xl">
                        ...
                        <h1 class="mt-5 text-4xl font-black tracking-tight text-slate-900 sm:text-5xl">Body Assessment</h1>
                        <p class="mt-4 text-lg leading-relaxed text-slate-600">
                            Answer 90 questions across physical vitality, somatic tension, and autonomic regulation. The ideal response is "Not at all" and the non-ideal response is "Nearly every day". Select a module below to start, or click on a history log to review past outcomes.
                        </p>
                    </div>
                ...
                <div class="rounded-[32px] bg-[linear-gradient(180deg,#fff7fb_0%,#fff1f6_100%)] p-7 sm:p-10 shadow-[0_20px_55px_rgba(89,29,63,.05)] ring-1 ring-fuchsia-100/70 relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <div class="mt-6 grid gap-4 sm:grid-cols-2 md:grid-cols-3">
                            <!-- Test 1 -->
                            <a href="{{ route('assessment.exam', ['track' => 'body', 'module' => 'Physical Vitality & Energy']) }}" class="group relative block rounded-[24px] bg-white p-5 shadow-sm ring-1 ring-fuchsia-100 transition hover:-translate-y-1 hover:shadow-[0_12px_28px_rgba(190,24,93,.12)]">
                                ...
                                <h3 class="mt-4 text-lg font-black text-slate-900 leading-tight">Physical Vitality & Energy</h3>
                                <p class="mt-1 text-sm font-semibold text-fuchsia-600">30 questions</p>
                            </a>

                            <!-- Test 2 -->
                            <a href="{{ route('assessment.exam', ['track' => 'body', 'module' => 'Somatic Tension & Pain']) }}" class="group relative block rounded-[24px] bg-white p-5 shadow-sm ring-1 ring-fuchsia-100 transition hover:-translate-y-1 hover:shadow-[0_12px_28px_rgba(190,24,93,.12)]">
                                <div class="absolute right-4 top-4 h-8 w-8 rounded-full bg-fuchsia-50 flex items-center justify-center text-fuchsia-600 group-hover:bg-fuchsia-100 transition">
                                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
                                </div>
                                ...
                                <h3 class="mt-4 text-lg font-black text-slate-900 leading-tight">Somatic Tension & Pain</h3>
                                <p class="mt-1 text-sm font-semibold text-fuchsia-600">30 questions</p>
                            </a>

                            <!-- Test 3 -->
                            <a href="{{ route('assessment.exam', ['track' => 'body', 'module' => 'Autonomic Regulation']) }}" class="group relative block rounded-[24px] bg-white p-5 shadow-sm ring-1 ring-fuchsia-100 transition hover:-translate-y-1 hover:shadow-[0_12px_28px_rgba(190,24,93,.12)]">
                                <div class="absolute right-4 top-4 h-8 w-8 rounded-full bg-fuchsia-50 flex items-center justify-center text-fuchsia-600 group-hover:bg-fuchsia-100 transition">
                                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
                                </div>
                                ...
                                <h3 class="mt-4 text-lg font-black text-slate-900 leading-tight">Autonomic Regulation</h3>
                                <p class="mt-1 text-sm font-semibold text-fuchsia-600">30 questions</p>
                            </a>
                        </div>
                    </div>
                ...
                <div class="rounded-[32px] bg-white p-7 sm:p-10 shadow-[0_20px_55px_rgba(89,29,63,.1)] ring-1 ring-fuchsia-100/70 transition-all duration-300" id="latest-result-container">
                    ...
                    <div class="mt-6 grid gap-4 sm:grid-cols-2">
                        <div class="rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-100 flex items-center justify-between">
                            <p class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-400">Vitality Level</p>
                            <p class="text-lg font-bold text-slate-900" id="result-mood">{{ $historyLogs[0]['mood'] }}</p>
                        </div>
                        <div class="rounded-2xl bg-slate-50 p-4 ring-1 ring-slate-100 flex items-center justify-between">
                            <p class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-400">Tension Level</p>
                ...
                <div class="rounded-[32px] bg-white p-8 shadow-[0_20px_55px_rgba(89,29,63,.1)] ring-1 ring-fuchsia-100/70 flex flex-col items-center justify-center">
                    ...
                    <div class="mt-4 relative flex h-64 w-64 items-center justify-center rounded-full bg-[linear-gradient(180deg,#fff7fb_0%,#fff1f6_100%)] shadow-inner shadow-fuchsia-100 mx-auto">
                        ...
                        <div class="text-center relative z-10 px-4">
                            ...
                            <p class="mt-2 text-xs font-semibold uppercase tracking-[0.2em] text-fuchsia-600">Health</p>
                        </div>
                    </div>
                </div>
